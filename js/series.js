...
$(function() {
   ...
   *  -- series races feed
   */
  var seriesURL = "https://www.hendersonvillerunningclub.com/api/" + year + "_race_series.json?start_date=" + now;
      ...
      if (days_to_race >= -2 && days_to_race <= 14) {
        if (data.results[i].date.length > 4) {
          if (days_to_race <= 14 && days_to_race >= 8) {
            ...
            alert_image="https://www.hendersonvillerunningclub.com/img/AthlinkRegister";
            ...
            alert_image="https://www.hendersonvillerunningclub.com/img/AthlinkResults";
